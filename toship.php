		...
		<div class="col-md-5 col-12" align="right">
			...
			<div class="my-md-2">
				<div class="input-group">
					<input class="searchkey" type="text" name="searchkey" placeholder="Search To Ship Orders">
...
<ul class="nav nav-pills nav-fill">
  ...
  <li class="nav-item">
    <a class="nav-link active"  style="background-color:#29a3a3;" aria-current="page"   href="toship.php"> To Ship </a>
  </li>
    <li class="nav-item">
	...
	<div class="row">
		...
		<div class="col-3">
			<div class="order_total">
				...
				<p class="order_total"> Php <?php  echo number_format($value['order_total']);?></p>
				<p>Item Packed</p>
