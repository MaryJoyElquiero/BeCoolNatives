...
<div class="container-fluid" id="content">
  ...
  <li class="nav-item">
  	<a class="nav-link "  style="background-color:white;color:black;" href=" sellerreport.php"> Seller Report</a>
    
  </li>
    <li class="nav-item">
   <a class="nav-link active"  style="background-color:#29a3a3;" aria-current="page"  href="adminReport 1.php"> Registered Accounts </a>
    ...
    <div class="container-fluid">
    	...
    	<div class="col">
    		...
    		$sql= "SELECT acc_cn, 
				...
				echo "<td>". $value['acc_gender'] ."</td>";
				echo "<td>". $value['acc_contact'] ."</td>";
				echo "<td> ". $value['province'] ." ," . $value['city'] ." ,". $value['brgy'] ." ,". $value['add_details']. "</td>";
				echo "</tr>";
			    }
			    echo "<tr>";
