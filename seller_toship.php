...
<ul class="nav nav-pills nav-fill">
  ...
  <li class="nav-item">
    <a class="nav-link"  href="seller_topack.php"> To Pack </a>
  </li>
  <li class="nav-item">
    <a class="nav-link active"  style="background-color:#29a3a3;" aria-current="page" href="seller_toship.php"> To Ship </a>
  </li>
    <li class="nav-item">
	...
	<div class="row items">
		...
		<div class="col-3">
			<div class="order_total">
				...
				<button class="btn btn-outline-success" name="shipped">Shipped</button>
				</form>
			</div>
		</div>
