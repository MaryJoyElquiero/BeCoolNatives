...
<div class="container-fluid" id="content">
  ...
  <li class="nav-item">
  <a class="nav-link active"  style="background-color:#29a3a3;" aria-current="page"  href="adminReport 2.php">Shop Total Sales </a>
    ...
    <div class="container-fluid">
    	...
    	<div class="col">
    		...
    		$sql= "SELECT 
				...
				echo "<td>". $value['shop_itemscount'] ."</td>";
