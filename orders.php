...
<ul class="nav nav-pills nav-fill">
  <li class="nav-item">
    <a class="nav-link active"  style="background-color:#29a3a3;" aria-current="page" href="orders.php">All</a>
  </li>
  <li class="nav-item">
	...
	<div class="row items">
		...
		<div class="col-3">
			<div class="order_total">
				...
				<p> <?php 
				 if($value['order_status']=="To Pay"){
					echo "To Pack";
				}
				elseif ($value['order_status']=="To Recieve") {
					echo "Shipped";
				}
				else{
					echo $value['order_status'];}?></p>
			</div>
		</div>
